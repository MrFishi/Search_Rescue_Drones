...
Thesis project: heterogeneous UAV fleet collaboratively searching for missing persons
using distributed information sharing and dynamic re-tasking.
...
| AI Compute (future) | Jetson Orin NX |
